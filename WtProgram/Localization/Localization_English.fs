...
module Localization_English =
    let strings = dict [
        ...
        ("LockWindowPosition", "Prevent moving windows and resizing them from the top")
        ...
        ("MatchTypeExactMatch", "Exact match")
        ("MatchTypeStartsWith", "Starts with")
        ("MatchTypeEndsWith", "Ends with")
        ...
        ("WorkspaceNameSettings", "Workspace Name")
        ...
        ("CloseSelectedTabsPlusTargetFormat", "Close {0} selected tabs + target tab")
        ...
        ("AlignSelectedTabsLeftPlusTargetFormat", "Align {0} selected tabs + target tab to Left")
        ("AlignSelectedTabsRightFormat", "Align {0} selected tabs to Right")
        ("AlignSelectedTabsRightPlusTargetFormat", "Align {0} selected tabs + target tab to Right")
        ("AlignTopLeft", "Left")
        ("AlignTopRight", "Right")
        ...
        ("PinSelectedTabsPlusTargetFormat", "Pin {0} selected tabs + target tab")
        ("UnpinSelectedTabsFormat", "Unpin {0} selected tabs")
        ("UnpinSelectedTabsPlusTargetFormat", "Unpin {0} selected tabs + target tab")
        ...
        ("TabColorSelectedTabsPlusTargetFormat", "Selected {0} tabs + target tab color")
        ("TabColorClearSelectedTabsFormat", "Clear selected {0} tabs color")
        ("TabColorClearSelectedTabsPlusTargetFormat", "Clear selected {0} tabs + target tab color")
        ...
        ("SystemCopySelectedTabsExePathPlusTargetFormat", "Copy {0} selected tabs + target tab process paths")
        ("SystemCopySelectedTabsWindowTitleFormat", "Copy {0} selected tabs window titles")
        ("SystemCopySelectedTabsWindowTitlePlusTargetFormat", "Copy {0} selected tabs + target tab window titles")
