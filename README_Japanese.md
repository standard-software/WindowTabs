...
最新のバージョン: **ss_jp_2026.04.22_next1**
...
- **タブのコンテキストメニュー**: 右クリックでタブの様々な機能にアクセスできます
  - 新規起動: (exe名) (サブメニュー: 同じグループに新規タブ、位置指定で新規ウィンドウ、別グループへ連結して新規ウィンドウ)
  ---
  - 左スナップ / 右スナップ
  ...
  - 他のグループへ連結
  ---
  - タブの分離と分割 (サブメニュー: トップに左/右スナップ、その他は「その他の位置調整」配下)
  ---
  - タブを閉じる (サブメニュー: このタブ、左側のタブ/右側のタブ、その他タブ、すべてのタブ)
  ---
  - タブのピン止め (サブメニュー: このタブのピン止め/解除、左右タブのピン止め/解除のペア操作、左タブと右タブのグループの間に区切り線)
  - タブの色変更 (範囲別サブメニュー — このタブ・左のタブ・右のタブ — 塗りつぶし/下線/枠線タイプ、各サブメニューに「色設定をクリア」を併設)
  ---
...
タブのコンテキストメニューから、そのタブの実行ファイルを直接新規起動できます。3つのバリエーションがあります:

- **同じグループに新規タブ**: 新しいウィンドウを現在のタブグループに追加
- **位置指定で新規ウィンドウ**: 自動グループ化されない単独ウィンドウとして起動。左/右スナップ、または「その他の位置調整」サブメニューから位置を選択
- **別グループへ連結して新規ウィンドウ**: 既存のグループを選択して、単独ウィンドウをそのグループへ連結
- 「新規ウィンドウ」系のバリエーションは自動グループ化をバイパスするため、関係のないグループへの誤った結合を防ぎます
...
- タブを個別でピン止め/解除
- 同じ寄せグループ内の左側/右側のタブを一括でピン止め/解除 (左タブと右タブのグループは区切り線で分離)
...
- 色の選択は範囲別のサブメニュー（このタブ、左のタブ、右のタブ）に分かれています
- 各範囲のサブメニューの隣に「色設定をクリア」項目が配置され、素早く解除できます
