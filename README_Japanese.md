...
最新のバージョン: **ss_jp_2026.06.22_next1**
...
- 指定したタブを分離して他の位置に移動したり、他のタブグループに連結することができます。
- 複数タブをまとめて分離したいときは、先に [複数タブ選択](#複数タブ選択) を行ってから「選択した{N}タブを分離して位置移動」「選択した{N}タブを分離して他のグループへ連結」を実行します。
