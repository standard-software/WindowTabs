...
複数選択時 (後述の [複数タブ選択](#複数タブ選択) を参照) には、個別タブ向け項目が「選択した{N}タブ...」に変わり、アクティブタブと選択タブをまとめて操作対象にします。 単独タブを基準にする項目 (左側/右側のタブを閉じる、フォルダを開く、プロセスを強制終了) は Disabled になります。
...
- 複数タブをまとめて分離したいときは、先に複数タブ選択 (後述) を行ってから「選択した{N}タブを分離して位置移動」「選択した{N}タブを分離して他のグループへ連結」を実行します。

### 複数タブ選択

- Ctrl + クリックでタブを選択/選択解除できます。
- Shift + クリックでアクティブタブからの範囲選択ができます。
- 選択中のタブを右クリックすると、コンテキストメニューの個別タブ項目が「選択した{N}タブ...」に変わり、アクティブタブと選択タブをまとめて操作します (タブを閉じる / ピン止め / タブの色設定 / 個別タブ寄せ / タブの分離 / 他のグループへ連結 / システム の各「コピー」項目)。
- 単独タブを基準にする項目 (左側/右側のタブを閉じる) や、単一プロセスを対象にする項目 (フォルダを開く、プロセスを強制終了) は複数選択時には Disabled になります。
- 選択中のタブをドラッグすると、選択された全タブをまとめて他のタブグループに移動したり、新しいタブグループとして分離することができます。
