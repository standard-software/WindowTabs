...
- A window whose title did not survive the restart is found by its application and the position it reopened at. A browser shows its active tab in the title, so Edge or Chrome could come back reading differently and be left out of a group the others had already rejoined
