...
- Windows still waiting to open are kept in the settings file until they do, so a WindowTabs restart or a second Windows restart in between no longer loses the group. One that has not reopened in thirty days gives its place up and the entry goes
