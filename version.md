...
- Tab context menu: "Rename this tab", "Reset this tab name" and "Copy window title" show their name suffix again (their values can differ from the target-tab header)
