...
- Tab Detach menu: renamed from "Tab Detach and Split"; in multi-select, all Left/Right split items (both reposition and link-to-group variants) are grayed out because their pivot is ambiguous.
