...
- Windows still waiting to open are kept in the settings file until they do, so a WindowTabs restart or a second Windows restart in between no longer loses the group
