...
- A group whose windows are ALL still closed is held together too - the first one to appear forms the group and the rest join it, instead of each landing in a group of its own
